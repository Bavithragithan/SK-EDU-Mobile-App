...
export default function Quiz() {
    ...
    const onQuizFinish = async () => {
        ...
        // console.log("Final Quiz Result:", result);
        ...
        <View>
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <Progress.Bar progress={GetProgress(currentPage)} width={Dimensions.get('window').width * 0.85} color={Colors.WHITE} height={10} />
                </View>
                ...
                {(selectedOption?.toString() && quiz?.length - 1 == currentPage) &&
                    <Button text={"Finish"} loading={loading}

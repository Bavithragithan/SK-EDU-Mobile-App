...
export default {
  IDEA: dedent`:As your are coaching teacher
    ...
    - Generate 5 Course title for study (Short)
  ...
  COURSE: dedent`: As you are coaching teacher
    ...
    - Create 5 Courses With Course Name, Description, and 5/8 Chapters in each course
    - Make sure to add chapters 
    - List Content in each chapter along with Description in 2 to 3 lines
